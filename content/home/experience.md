...
[[experience]]
  ...
  date_end = "2020-11-11"
  description = """
   - Responsible forthe development of Wind Shear Application, built using R, Shiny Framework and AWS Stack, which uses machine learning techniques to predict windspeeds at target heights, which is used by Wind Engineers
